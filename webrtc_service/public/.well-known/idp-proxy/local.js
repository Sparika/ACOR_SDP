    ...
    var idp = {
        ...
        generateAssertion: (contents , origin) => {
            ...
            .then(function(data) {
               ...
               var obj =  {idp: {domain: 'localhost:4041',protocol: 'local.js'},
                    assertion: btoa(JSON.stringify(data))};
                return JSON.stringify(obj);

            }).catch(function(err) {
                console.log(err)
                console.log('promess non tenus !');
                throw err;
            })
        ...
        validateAssertion: (assertion, origin) => {
            ...
            return getAssertionById(jsonToVerify._id)
                .then(function(data) {
                    return data.json()
                })
                .then(function(json){
                   // console.log(assertion);
                    ...
                    //var identity = JSON.parse(json.user).email.split('@')[0]+"@localhost:4041"
                    //var obj ={identity:identity, contents:json.content}
                    console.log(json)
                    return json;
